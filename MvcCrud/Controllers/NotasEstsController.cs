...
namespace MvcCrud.Controllers
{
    public class NotasEstsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("IdNotasE,Nombre,Apellido,Ipn,Iipn,Siste,Proyect,Nf,Exci,Nfci,Excii,Nfcii")] NotasEst notasEst)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdNotasE,Nombre,Apellido,Ipn,Iipn,Siste,Proyect,Nf,Exci,Nfci,Excii,Nfcii")] NotasEst notasEst)
        {
